...
import { MyComponent } from '@codewit/ui';
...
const ModuleSection = ({ demo }: { demo: DemoResponse }) => (
  <div className="relative overflow-hidden w-48">
    ...
    <div className="p-1">
      <h3 className="font-medium text-sm mb-1 text-white">{demo.title}</h3>
    </div>
  </div>
);
      ...
      <div className="max-w-7xl mx-auto px-10 py-4">
        ...
        <div className="space-y-1.5">
          {course?.modules.map((module) => (
            <div
              key={module.uid}
              className="bg-foreground-500 overflow-hidden rounded-md font-bold"
            >
              <button
